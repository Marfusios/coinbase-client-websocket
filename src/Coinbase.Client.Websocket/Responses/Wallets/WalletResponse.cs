...
namespace Coinbase.Client.Websocket.Responses.Wallets
{
    ...
    public partial class WalletResponse
    {
        public static WalletResponse[] FromJson(string json) => JsonConvert.DeserializeObject<WalletResponse[]>(json, CoinbaseJsonSerializer.Settings);
    }

    public static partial class Serialize
    {
        public static string ToJson(this WalletResponse[] self) => JsonConvert.SerializeObject(self, CoinbaseJsonSerializer.Settings);
    }
