...
namespace Coinbase.Client.Websocket.Responses
{
    ...
    public class Currency
    {
        ...
        [JsonProperty("funding_account_id")] public Guid FundingAccountId { get; set; }
        ...
        [JsonProperty("convertible_to")] public QuoteCurrency[] ConvertibleTo { get; set; }
    ...
    {
        [JsonProperty("type")] public DetailsType Type { get; set; }
    ...
    public class Product
    {
        ...
        [JsonProperty("quote_currency")] public QuoteCurrency QuoteCurrency { get; set; }

        [JsonProperty("base_min_size")] public string BaseMinSize { get; set; }

        [JsonProperty("base_max_size")]
        [JsonConverter(typeof(ParseStringConverter))]
        public long BaseMaxSize { get; set; }

        [JsonProperty("base_increment")] public string BaseIncrement { get; set; }

        [JsonProperty("quote_increment")] public string QuoteIncrement { get; set; }
        ...
        [JsonProperty("min_market_funds")] public string MinMarketFunds { get; set; }
        ...
        [JsonProperty("type")] public ProductType Type { get; set; }
    }
    ...
    internal class QuoteCurrencyConverter : JsonConverter
    {
        ...
        {
            return t == typeof(QuoteCurrency) || t == typeof(QuoteCurrency?);
        }
    ...
    internal class DetailsTypeConverter : JsonConverter
    {
        ...
        public override bool CanConvert(Type t)
        {
            return t == typeof(DetailsType) || t == typeof(DetailsType?);
        }
    ...
    internal class ProductTypeConverter : JsonConverter
    {
        ...
        public override bool CanConvert(Type t)
        {
            return t == typeof(ProductType) || t == typeof(ProductType?);
        }
