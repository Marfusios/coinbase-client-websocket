...
public static class CoinbaseValues
{
    ...
    /// </summary>
    public static readonly Uri ApiWebsocketUrl = new("wss://ws-feed.pro.coinbase.com");

    /// <summary>
    /// Sandbox Coinbase Pro url to websocket API
    /// </summary>
    public static readonly Uri ApiWebsocketSandboxUrl = new("wss://ws-feed-public.sandbox.pro.coinbase.com");
}