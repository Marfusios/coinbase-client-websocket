...
public class CoinbaseStringEnumConverter : StringEnumConverter
{
    public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
    {
        ...
        {
            CoinbaseJsonSerializer.Logger.LogWarning(CoinbaseWebsocketClient.LogMessage($"Can't parse enum, value: {reader.Value}, target type: {objectType}, using default '{existingValue}'"));
            return existingValue;
        }
    }
}